		...
		<div class="overlay">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6">
						<h6 class="breadcrumb"><a href="../assets/index.html">Home</a> / About us</h6>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row text-center">
				...
				<div class="member col-xs-6 col-md-3">
					<div class="inner">
						...
						<div class="info">
							<div class="name"><a href="../assets/#"> Billy Yuriaan </a></div>
							<div class="regency">Leader</div>
						</div>
					</div>
				</div>
				...
				<div class="member col-xs-6 col-md-3">
					<div class="inner">
						<div class="avatar-inner"><img src="../assets/images/team2.png"></div>
						<div class="info">
							<div class="name"><a href="../assets/#"> Dewaka Rachmanda </a></div>
				...
				<div class="member col-xs-6 col-md-3">
					<div class="inner">
						...
						<div class="info">
							<div class="name"><a href="../assets/#"> Mary Bolung </a></div>
							<div class="regency">Staff</div>
						</div>
					</div>
				</div>
